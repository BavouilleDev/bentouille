  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">Mon compte Insta 📸</p>
        
        {/* Spacer to push button down */}
        <div className="flex-1" />
        
        <button className="btn-platform bg-gradient-to-r from-instagram to-instagram/90 text-white mt-auto text-xs w-full relative z-10 shadow-lg shadow-instagram/30 hover:shadow-instagram/50 transition-all duration-300">
